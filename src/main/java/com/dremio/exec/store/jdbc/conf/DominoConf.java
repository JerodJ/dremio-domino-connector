...
@SourceType(value = "DominoARP", label = "Domino",uiConfig = "domino-layout.json")
public class DominoConf extends AbstractArpConf<DominoConf> {
  private static final String ARP_FILENAME = "arp/implementation/domino-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.domino.DominoDriver";
